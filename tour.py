"""Nexora Investments - Premium Travel & Investment Opportunities Posting Module"""
...
PAGE_ID = os.environ.get("NEXORA_INVESTMENTS_PAGE_ID", "954901604381882")  # Nexora by Phoenix International
IMAGE_FOLDER = "images"
POST_INTERVAL = 30 * 60
FB_API_URL = f"https://graph.facebook.com/v19.0/{PAGE_ID}/photos"
POSTS_FILE = "posts/tour_posts.json"
MODULE_NAME = "Nexora Investments"
...
def run():
    """Run Nexora Investments posting cycle"""
    posts = load_posts()
    if not posts:
...
def stop():
    """Stop Nexora Investments posting cycle"""
    stop_event.set()
